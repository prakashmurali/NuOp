...
class TwoQubitGateSynthesizer:
    ...
    def optimal_decomposition(self, tol=1e-3, fidelity_2q_gate=1.0, fidelity_1q_gate=[1.0, 1.0]):
        max_num_layers = 4
...
def _driver_func(target_unitary, gate_def, gate_param, fidelity_2q_gate, fidelity_1q_gate, tol):
    attempts = 1
